(function() {
    ...
    1: [function(require, module, exports) {
        ...
        var createViewer = require("../index"),
            viewer = createViewer({ width: .4, height: .4, followMouse: !0, followMotion: !0 });
    ...
    3: [function(require, module, exports) {
        ...
        function setAttribute(t, e, n) { t.setAttributeNS(null, e, n) }
        ...
        module.exports = function(t) {
            ...
            function o() { var t, e = y.getBoundingClientRect(),
                    ...
                    r = e.height; for (b.length = 0, t = 0; t < S.length; ++t) { var o = S[t],
                        ...
                        w = M[3 * s]; if (!((c - f) * (M[3 * s + 1] - h) - (d - h) * (w - f) < 0)) { for (var v = [], g = -1 / 0, m = 1 / 0, p = o.svg, A = 0; A < 3; ++A) { var x = a[A];
                            ...
                            g = Math.max(g, F), m = Math.min(m, F) } o.zIndex = g + .25 * m; var N = v.join(" "); - 1 === N.indexOf("NaN") && setAttribute(p, "points", N), b.push(o) } } for (b.sort(i), y.innerHTML = "", t = 0; t < b.length; ++t) y.appendChild(b[t].svg) }
            ...
            function f() { if (v) { window.requestAnimationFrame(f); var t = 1 - m;
                ...
                b = [];
            h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0, A = 0 | (window.innerHeight * h.height || p), "minWidth" in h && p < h.minWidth && (p = h.minWidth, A = h.minWidth * h.height / h.width | 0)), setAttribute(y, "width", p + "px"), setAttribute(y, "height", A + "px"), document.body.appendChild(y),
                ...
                k = function() { var t = new Float32Array(3),
                        ...
                        h = new Float32Array([0, 0, 1]); return function() { var c = y.getBoundingClientRect(),
                            d = c.width,
                            v = c.height; if (perspective(n, Math.PI / 4, d / v, 100, 1e3), invert(a, n), l[0] = g[0], l[1] = g[1], l[2] = 1.2, transform(l, l, a), transform(l, l, o), lookAt(r, t, l, e), w) { var m = Date.now() / 1e3;
                        ...
                        r = event.beta;
                    yOffset = -300, acceleration = 10, e({ x: 200 + n * acceleration, y: yOffset + r * acceleration }), f() } }), f(), { container: y, lookAt: e, setFollowMouse: u, setFollowMotion: s, stopAnimation: a, startAnimation: l } };
    }, { "./fox.json": 2, "gl-mat4/invert": 6, "gl-mat4/lookAt": 7, "gl-mat4/multiply": 8, "gl-mat4/perspective": 9, "gl-mat4/rotate": 10, "gl-vec3/transformMat4": 11 }],
    4: [function(require, module, exports) {
        "use strict";

        function format(e) { var t = (/mac os x/i.test(navigator.userAgent) ? "⌘" : "Ctrl") + "+C"; return e.replace(/#{\s*key\s*}/g, t) }

        function copy(e, t) { var o, r, n, c, s, a, l = !1;
    ...
    8: [function(require, module, exports) {
        function multiply(l, t, u) { var r = t[0],
                ...
                h = u[1],
                j = u[2],
                k = u[3]; return l[0] = g * r + h * n + j * a + k * s, l[1] = g * e + h * o + j * c + k * v, l[2] = g * i + h * p + j * d + k * x, l[3] = g * m + h * y + j * f + k * b, g = u[4], h = u[5], j = u[6], k = u[7], l[4] = g * r + h * n + j * a + k * s, l[5] = g * e + h * o + j * c + k * v, l[6] = g * i + h * p + j * d + k * x, l[7] = g * m + h * y + j * f + k * b, g = u[8], h = u[9], j = u[10], k = u[11], l[8] = g * r + h * n + j * a + k * s, l[9] = g * e + h * o + j * c + k * v, l[10] = g * i + h * p + j * d + k * x, l[11] = g * m + h * y + j * f + k * b, g = u[12], h = u[13], j = u[14], k = u[15], l[12] = g * r + h * n + j * a + k * s, l[13] = g * e + h * o + j * c + k * v, l[14] = g * i + h * p + j * d + k * x, l[15] = g * m + h * y + j * f + k * b, l } module.exports = multiply;
    }, {}],
    9: [function(require, module, exports) {
        function perspective(e, t, r, p, n) { var a = 1 / Math.tan(t / 2),
                c = 1 / (p - n); return e[0] = a / r, e[1] = 0, e[2] = 0, e[3] = 0, e[4] = 0, e[5] = a, e[6] = 0, e[7] = 0, e[8] = 0, e[9] = 0, e[10] = (n + p) * c, e[11] = -1, e[12] = 0, e[13] = 0, e[14] = 2 * n * p * c, e[15] = 0, e } module.exports = perspective;
    ...
    11: [function(require, module, exports) {
        function transformMat4(r, t, a) { var n = t[0],
                o = t[1],
                e = t[2],
                f = a[3] * n + a[7] * o + a[11] * e + a[15]; return f = f || 1, r[0] = (a[0] * n + a[4] * o + a[8] * e + a[12]) / f, r[1] = (a[1] * n + a[5] * o + a[9] * e + a[13]) / f, r[2] = (a[2] * n + a[6] * o + a[10] * e + a[14]) / f, r } module.exports = transformMat4;

    }, {}],
    12: [function(require, module, exports) {
        module.exports = function() { var e = document.getSelection(); if (!e.rangeCount) return function() {}; for (var n = document.activeElement, t = [], a = 0; a < e.rangeCount; a++) t.push(e.getRangeAt(a)); switch (n.tagName.toUpperCase()) {
                case "INPUT":
                case "TEXTAREA":
                    n.blur(); break;
                default:
                    n = null } return e.removeAllRanges(),
                function() { "Caret" === e.type && e.removeAllRanges(), e.rangeCount || t.forEach(function(n) { e.addRange(n) }), n && n.focus() } };
    }, {}]
}, {}, [1]);